...
import Loading from "../helples/loading";
import { useDispatch, useSelector } from "react-redux";
// import { authSelect } from "../../redux/features/authSlice";
// import AddAddress from "../../components/AddAddress";
import Modal from "../helples/modal";
...
const AddressPage = () => {
    ...
    const listAddresses = [
        ...
        },
        {
            ...
            phone: "0987654321",
            exactAddress: "Địa chỉ 2, Quận 2",
            district: "Quận 2",
            ward: "Phường 2",
            province: "TP. Hồ Chí Minh",
        },
        // Thêm các địa chỉ giả khác...
    ];

    // const { userInfo } = useSelector(authSelect);
    const addressDefaultId = 2
    // useEffect(() => {
                ...
                {listAddresses?.length > 0 ? (
                    listAddresses.map((address) => {
                        return (
                            <div key={address?._id}>
                                <div
                                    className={`${addressDefaultId === address?._id &&
